...
brightness = st.sidebar.slider("Brightness", 0.01, 50.0, 1.0)
contrast = st.sidebar.slider("Contrast", 0.01, 50.0, 1.0)
sharpness = st.sidebar.slider("Sharpness", 0.01, 10.0, 1.0)
